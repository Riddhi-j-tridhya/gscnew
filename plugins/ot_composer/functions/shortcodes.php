...
?>
  <div class="loan-block">
      <div class="loan-icon"><img src="<?php echo esc_url($img); ?>" alt=""></div>
...
<?php if($style=='style1'){ ?>
  ...
  <div class="procwss-v2 bg-white number-block mb30 ">
      <div class="process-img"><?php if($img!=''){ ?><img src="<?php echo esc_url($img); ?>" alt="" class="rounded-circle"><?php } ?>
          <?php if($number!=''){ ?><div class="circle"><span class="number"><?php echo htmlspecialchars_decode($number); ?></span></div><?php } ?>
      </div>
      <div class="pinside20">
  ...
  ?>
    <?php 
        ...
        if( $col == 3 ){
            ...
            if($i%4==1){
            $columns2 = 'col-xl-3 col-lg-3 col-md-3 col-sm-3 col-6 clear';
            }else{
            $columns2 = 'col-xl-3 col-lg-3 col-md-3 col-sm-3 col-6';
            }
        }
    ?>
<?php if($style=='style1'){ ?>
              ...
              <div class="post-caption-img">
                  ...
                  <?php if( function_exists( 'rwmb_meta' ) ) { ?>
                      ...
                      <?php if($images){ ?>              
                          <?php  foreach ( $images as $image ) {  ?>
                              <?php $img = $image['full_url']; ?>
                              <img src="<?php echo esc_url($img); ?>" class="img-responsive img-fluid" alt="">
                          <?php } ?>                
                      <?php }else{
                          if ( has_post_thumbnail() ) { // check if the post has a Post Thumbnail assigned to it.
