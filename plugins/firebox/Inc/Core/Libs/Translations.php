...
class Translations
{
	...
	public function getTranslations()
	{
		return [
			...
			'FB_METABOX_OPENING_BEHAVIOR_DESC' => __('Choose how your campaign will behavior prior to your users seeing it.', 'firebox'),
			...
			'FB_AVERAGE_TIME_OPEN' => __('Average Time Open', 'firebox'),
			...
			'FB_CONVERSIONS_TOOLTIP_DESC' => __('The total user interactions, including form submissions and clicks on campaign elements (coming soon), indicating successful engagement.', 'firebox'),
			'FB_VS_PREVIOUS_PERIOD' => __('vs period period', 'firebox'),
			...
			'FB_SHOWING_FIRST_30_RESULTS' => __('Showing first 30 results.', 'firebox'),
