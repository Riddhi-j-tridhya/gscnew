...
class Admin
{
	...
	{
		if (in_array($this->getPageNow(), ['edit.php', 'post-new.php']) && isset($_GET['post_type']) && $_GET['post_type'] == 'firebox')
		{
			return true;
		}
	...
	public function registerScripts()
	{
		...
		$data = array(
			...
			'langs' => [
				...
				'AVERAGE_TIME_OPEN' => firebox()->_('FB_AVERAGE_TIME_OPEN'),
				...
				'SHOWING_FIRST_30_RESULTS' => firebox()->_('FB_SHOWING_FIRST_30_RESULTS'),
