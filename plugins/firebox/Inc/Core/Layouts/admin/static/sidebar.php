...
<div class="fpframework-admin-container--sidebar--outer border-r-[1px] border-grey-3 border-solid border-t-0 border-l-0 border-b-0 sticky top-2 w-[207px] max-h-screen z-1 shrink-0 dark:border-default">
	<div class="fpframework-admin-container--sidebar--outer--inner shrink-0 px-3 py-5 h-full flex flex-col justify-between relative">
		...
		<div class="flex flex-col gap-5 fpframework-admin-container--sidebar--outer--inner--item">
			...
			<div class="flex flex-col">
				<a href="https://www.fireplugins.com/contact/?plugin=<?php esc_attr_e($plugin_name); ?>&topic=Other" target="_blank" class="py-[11px] font-medium no-underline text-default dark:text-white shadow-none hover:text-accent dark:hover:text-dark-accent text-base"><?php esc_html_e(fpframework()->_('FPF_GIVE_FEEDBACK')); ?></a>
				<a href="https://www.fireplugins.com/<?php esc_attr_e($plugin_slug); ?>/changelog/" target="_blank" class="py-[11px] font-medium no-underline text-default dark:text-white shadow-none hover:text-accent dark:hover:text-dark-accent text-base"><?php esc_html_e(fpframework()->_('FPF_WHATS_NEW')); ?></a>
