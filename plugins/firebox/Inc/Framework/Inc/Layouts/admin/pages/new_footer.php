...
<div class="flex flex-col gap-2 items-center text-gray-500 dark:text-grey-3 mt-10">
	<?php if ($show_copyright) { ?>
		...
		<div class="flex gap-1 flex-wrap items-center">
			<a href="https://www.facebook.com/fireplugins" target="_blank" class="no-underline text-current hover:text-black dark:hover:text-gray-300">
				<span class="dashicons dashicons-facebook-alt"></span>
			</a>
			<a href="https://www.twitter.com/firepluginsdev" target="_blank" class="no-underline text-current hover:text-black dark:hover:text-gray-300">
				<span class="dashicons dashicons-twitter"></span>
			</a>
			<a href="https://www.linkedin.com/company/fireplugins" target="_blank" class="no-underline text-current hover:text-black dark:hover:text-gray-300">
