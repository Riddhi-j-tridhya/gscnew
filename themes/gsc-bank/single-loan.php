              ...
              <div class="row">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                  <div class="btn-action"> 
                    <a href="<?php echo esc_url($link1); ?>" class="btn btn-primary popmake-4219"><?php echo esc_attr($text1); ?></a> 
                    <a href="<?php echo site_url(); ?>/emi-calculator/" class="btn btn-default "><?php echo esc_attr($text2); ?></a> 
                  </div>
                </div>
              </div>
            </div>
