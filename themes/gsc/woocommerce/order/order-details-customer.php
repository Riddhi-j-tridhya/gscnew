 ...
 *
 * This template can be overridden by copying it to gsc-bank/woocommerce/order/order-details-customer.php.
 *
...
<section class="woocommerce-customer-details">
	<h2 class="woocommerce-column__title"><?php esc_html_e( 'Billing address', 'gsc-bank' ); ?></h2>
	...
	<ul class="vct-billing-details-container">
		...
		<?php if ( $order->get_billing_city() || $order->get_billing_address_1() || $order->billing_address_2() ) : ?>
			<li class="vct-billing-detail">
				<span><?php esc_html_e( 'Address', 'gsc-bank' ); ?></span>
				<span>
					<?php
		...
		<?php if ( $order->get_billing_postcode() ) : ?>
			<li class="vct-billing-detail">
				<span><?php esc_html_e( 'Postal Code', 'gsc-bank' ); ?></span>
