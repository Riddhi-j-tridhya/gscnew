 ...
 * Order details
 *
 * This template can be overridden by copying it to gsc-bank/woocommerce/order/order-details.php.
 *
...
?>
	<section class="woocommerce-order-details">
		<div class="vct-order-container">
			<h3 class="woocommerce-order-details__title"><?php esc_html_e( 'Order details', 'gsc-bank' ); ?></h3>

			<ul class="vct-order-details-container">

				<li class="vct-order-detail">
					<span><?php esc_html_e( 'Order number:', 'gsc-bank' ); ?></span>
					<span><?php echo esc_html( $order->get_order_number() ); ?></span>
				</li>
				<li class="vct-order-detail">
					<span><?php esc_html_e( 'Date:', 'gsc-bank' ); ?></span>
					<span>
						<?php
				...
				<?php if ( $order->get_customer_note() ) : ?>
					<li class="vct-order-detail">
						<span><?php esc_html_e( 'Note:', 'gsc-bank' ); ?></span>
						<span>
							<?php
							// @codingStandardsIgnoreLine
