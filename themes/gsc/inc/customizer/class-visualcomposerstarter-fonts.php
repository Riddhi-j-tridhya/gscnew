...
class VisualComposerStarter_Fonts {
	...
	protected static function vct_get_fonts_list() {
		$heading1 = array(
			1 => array(
				'label' => sprintf( '--- %s ---', esc_html__( 'Standard Fonts', 'gsc-bank' ) ),
			),
		);
		$standard_fonts = self::vct_theme_standard_fonts();
		$heading2 = array(
			2 => array(
				'label' => sprintf( '--- %s ---', esc_html__( 'Google Fonts', 'gsc-bank' ) ),
			),
		);
	...
	public static function vct_theme_font_subsets() {
		return array(
			'all'     => esc_html__( 'All', 'gsc-bank' ),
			'cyrillic'   => esc_html__( 'Cyrillic', 'gsc-bank' ),
			'cyrillic-ext' => esc_html__( 'Cyrillic Extended', 'gsc-bank' ),
			'devanagari'  => esc_html__( 'Devanagari', 'gsc-bank' ),
			'greek'    => esc_html__( 'Greek', 'gsc-bank' ),
			'greek-ext'  => esc_html__( 'Greek Extended', 'gsc-bank' ),
			'khmer'    => esc_html__( 'Khmer', 'gsc-bank' ),
			'latin'    => esc_html__( 'Latin', 'gsc-bank' ),
			'latin-ext'  => esc_html__( 'Latin Extended', 'gsc-bank' ),
			'vietnamese'  => esc_html__( 'Vietnamese', 'gsc-bank' ),
		);
	}
